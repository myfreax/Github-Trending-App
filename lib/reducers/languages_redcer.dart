...
List<String> _setLoadedlanguages(
    List<String> languages, LanguagesLoadedAction action) {
  return action.languages;
}

List<String> _setNolanguages(
    List<String> languages, LanguagesNotLoadedAction action) {
  return [];
}
